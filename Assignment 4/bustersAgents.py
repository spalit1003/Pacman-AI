...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for i in livingGhostPositionDistributions:
            tempDist = self.distancer.getDistance(pacmanPosition, i.argMax())
        ...
        distance1 = float("inf")
        for j in legal:
            tempDist1 = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, j), ghostPos)
            if tempDist1 < distance1:
                distance1 = tempDist1
                action = j
        return action
